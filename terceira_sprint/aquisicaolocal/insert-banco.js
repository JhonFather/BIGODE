...
function registrar_leitura(temperatura, umidade) {
    ...
    banco.conectar().then(() => {
        ...
        return banco.sql.query(`INSERT into dados (datahora, temperatura, umidade,fkSensor )
                                values (CURRENT_TIMESTAMP,${temperatura}, ${umidade},1 );`);
